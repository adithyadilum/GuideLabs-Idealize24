            ...
            {showQuestion ? (
                ...
                <>
                    <div className="navBar">
                        <ScrollEffect>
                            <div className="logo">
                                <img src="src\assets\logo-project 3-01.svg" alt="" />
                                <p>GuideLabs</p>
                            </div>
                            <div className="navLinks">
                                <a href="#" onClick={() => scrollToSection(section1Ref)}>Who are we?</a>
                                <a href="#" onClick={() => scrollToSection(section2Ref)}>What we do</a>
                                <a href="#" onClick={() => scrollToSection(section5Ref)}>Testimonials</a>
                                <a href="#" onClick={() => scrollToSection(section6Ref)}>Pricing</a>
                                <a href="#" onClick={() => scrollToSection(footerRef)}>Contact</a>
                            </div>
                        </ScrollEffect>
                    </div>
                    <div className="hero">
                        <div className="heroWrapper">
                            <div className="title">
                                ...
                                <h1>GuideLabs : <span> Where Dreams Meets Direction</span></h1>
                    ...
                    <section id="section2" ref={section2Ref} className="section2">
                        <div>
                            <ScrollEffect>
                                <div className='imgPlaceholder'>
                                    <img src="src\assets\Learning-bro.svg" alt="" />
                                </div>
                            </ScrollEffect>
                            <ScrollEffect>
                                <div>
                        ...
                        <div>
                            ...
                            <ScrollEffect>
                                <div className='imgPlaceholder'>
                                    <img src="src\assets\Success factors-bro.svg" alt="" />
                                </div>
                            </ScrollEffect>
                        </div>
                    </section>
